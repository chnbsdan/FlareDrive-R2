  ...
  >
    ...
    <div class="app-bar">
      <a class="app-title-container" style="display: flex; align-items: center;" href="/">
        <img src="/assets/homescreen.png" alt="航丹云盘" style="height: 24px" />
        <h1 class="app-title" style="font-size: 20px;margin: 0 25px 0 8px; user-select: none;">航丹云盘</h1>
      </a>
...
export default {
  data: () => ({
    ...
    uploadProgress: null,
    uploadQueue: [],
    backgroundImageUrl: "https://img.hangdn.com/hexo/girl.webp"
  }),
    ...
    cwd: {
      handler() {
        ...
        document.title = this.cwd.replace(/.*\/(?!$)|\//g, "") === "/" 
            ? "FlareDrive-R2 - BSDAN网盘文件库"
            :`${this.cwd.replace(/.*\/(?!$)|\//g, "") || "/" } - BSDAN网盘文件库`;
      },
      immediate: true,
    },
  },
